...
// c_compute_bm
List c_compute_bm(List nn, SEXP covariate_in);
RcppExport SEXP HGTools_c_compute_bm(SEXP nnSEXP, SEXP covariate_inSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< List >::type nn(nnSEXP);
    Rcpp::traits::input_parameter< SEXP >::type covariate_in(covariate_inSEXP);
    __result = Rcpp::wrap(c_compute_bm(nn, covariate_in));
    return __result;
END_RCPP
}
...
List c_generate_initial_variables_bm(SEXP data, SEXP covariate_bm, SEXP response_bm, List model_list, String act_fct, String err_fct);
RcppExport SEXP HGTools_c_generate_initial_variables_bm(SEXP dataSEXP, SEXP covariate_bmSEXP, SEXP response_bmSEXP, SEXP model_listSEXP, SEXP act_fctSEXP, SEXP err_fctSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< SEXP >::type data(dataSEXP);
    Rcpp::traits::input_parameter< SEXP >::type covariate_bm(covariate_bmSEXP);
    Rcpp::traits::input_parameter< SEXP >::type response_bm(response_bmSEXP);
    Rcpp::traits::input_parameter< List >::type model_list(model_listSEXP);
    Rcpp::traits::input_parameter< String >::type act_fct(act_fctSEXP);
    Rcpp::traits::input_parameter< String >::type err_fct(err_fctSEXP);
    __result = Rcpp::wrap(c_generate_initial_variables_bm(data, covariate_bm, response_bm, model_list, act_fct, err_fct));
    return __result;
END_RCPP
}
