...
# assertive package.  After contact the maintainer,
...
# wish to extend the use of this core function for other assers.
# I will remove once the function is exported form the assertive package.
assert_engine <-
